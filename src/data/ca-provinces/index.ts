...
export const caStateMode: GameModeConfig = {
  ...
  questionOptions: [
    { labelKey: "content-type.ca-provinces-name", value: "name" },
    { labelKey: "content-type.ca-provinces-nameNative", value: "nameNative" },
    { labelKey: "content-type.ca-provinces-capital", value: "capital" },
  ],
  answerOptions: [
    { labelKey: "content-type.ca-provinces-name", value: "name" },
    { labelKey: "content-type.ca-provinces-nameNative", value: "nameNative" },
